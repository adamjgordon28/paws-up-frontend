  ...
  render(){
    return(
      ...
      <h1>Create a pet!</h1>
        ...
        <input placeholder="Name" onChange={this.handleChange} name="name" type="text"/>
        ...
        placeholder="Age (in months)" min="1" name="age" type="number"/>
        <select onChange={this.handleChange} name="allergy">
