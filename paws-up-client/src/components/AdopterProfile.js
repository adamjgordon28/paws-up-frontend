      ...
      if (this.props.currentUser){
        return (
          <div className="currentUserProfile">
            <Card>
              <Image src={this.props.currentUser.img_url} />
              <Card.Content>
              <Card.Header>{this.capitalize(this.props.currentUser.name)}</Card.Header>
              <Card.Description> username : {this.props.currentUser.username}</Card.Description>
              </Card.Content>
            </Card>
    ...
    renderAdopterMeetings = () => {
      if(this.props.currentUser){
        if(this.props.currentUser.meetings.length){
          ...
          return(<div style={{position:"relative", top:"3em"}} className="ui message huge">
